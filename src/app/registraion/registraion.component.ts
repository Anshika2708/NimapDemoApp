...
export class RegistraionComponent {
  data:any;
  constructor(private http:HttpClient,private register:RegisterService,private fb: FormBuilder, private modalService: NgbModal, private router: Router,private serv: ServicesService,){
    this.createForm();
  }

  onSubmit(data: any)
  {
    this.http.post('http://localhost:3000/home',data)
    .subscribe((result)=>{
